...
#define STREAM_INTERARRIVAL  48  /* Random-number stream for interarrivals. */
#define STREAM_SERVICE       33  /* Random-number stream for service times. */
...
int main()  /* Main function. */
{
    ...
    infile = fopen("mm1sim.txt", "r");
    outfile = fopen("mm1smlb_48_33.out", "w");
